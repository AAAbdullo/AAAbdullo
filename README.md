...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1200&color=02569B&center=true&vCenter=true&width=650&lines=Mobile+Developer+%F0%9F%9A%80;Flutter+%26+Dart+Specialist+%F0%9F%92%99;Building+the+future+at+a+Research+Institute+%F0%9F%8F%9B%EF%B8%8F;Always+learning%2C+always+improving+%E2%9C%A8" />
</p>
...
Я — специалист отдела разработки программных продуктов в государственном научно-исследовательском институте. Занимаюсь созданием технологичных решений, уделяя внимание архитектуре и качеству интерфейсов.

- 📱 **Специализация:** Кроссплатформенная мобильная разработка на **Flutter** и **Dart**
- 🏗 **Архитектура:** Использую современные подходы (**BLoC**, **Riverpod**) для создания надёжных систем
- 🧪 **Исследования:** Работаю над проектами автоматизации и цифровизации в государственном секторе
- 🌱 **Сейчас изучаю:** **Python** для задач автоматизации и бэкенд-разработки
...
| :--- | :--- | :--- |
| 🎓 **raqamli_institute** | Платформа управления образовательным процессом | Flutter, Dart |
| 🚗 **avto_service** | Система мониторинга и записи на техобслуживание | Flutter, SQLite |
| 📰 **news_app** | Быстрый агрегатор новостей с кастомными анимациями | Flutter, Dart |
| 📝 **note_app** | Минималистичное приложение для заметок | Flutter, Hive |
...
<p align="center">
  ...
  <br/>
  <img src="https://img.shields.io/badge/BLoC-5892D1?style=for-the-badge&logo=flutter&logoColor=white" />
